...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "gallery" ADD COLUMN "photo_id" integer;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "gallery" DROP CONSTRAINT "gallery_photo_id_media_id_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_media_fk";
  
  DROP INDEX "gallery_photo_idx";
  DROP INDEX "payload_locked_documents_rels_media_id_idx";
  ALTER TABLE "gallery" ALTER COLUMN "image" SET NOT NULL;
  ALTER TABLE "gallery" DROP COLUMN "photo_id";
